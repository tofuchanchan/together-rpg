...
export class View{
 ...
 draw(dt=0){
  ...
  c.restore();if(w.mode!=='menu')this.hud();if(w.mode==='menu')this.menu();if(w.mode==='upgrade')this.upgrade();if(w.mode==='shop')drawShop(this);if(['paused','complete','defeat','victory'].includes(w.mode))this.modal();this.drawNavigation();
 }
