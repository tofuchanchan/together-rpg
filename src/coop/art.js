...
export function text(c,s,x,y,size=18,color=CREAM,align='left',weight=700){c.fillStyle=color;c.font=`${weight} ${size}px "Microsoft YaHei",system-ui,sans-serif`;c.textAlign=align;c.textBaseline='middle';c.fillText(s,x,y);}
