...
export function celFrame(clip,time,{haste=1,loop=true}={}){
 const timing=actionTiming('warrior','attack',haste),duration=clip==='walk'?WALK_SECONDS:clip==='idle'?2.4:timing.duration;
...
export function celFrameTime(clip,frame){return clip==='walk'?frame*WALK_SECONDS/8:clip==='idle'?frame*2.4/8:ATTACK_FRACTIONS[frame]*actionTiming('warrior','attack').windup;}
