...
export function combatStats(e,enraged){const d=enemyDef(e);return enraged&&!e.boss?{...d,speed:d.speed*ENRAGE.speed,damage:d.damage*ENRAGE.damage,contactDamage:(d.contactDamage||0)*ENRAGE.damage,cd:d.cd/ENRAGE.attackRate}:d;}
