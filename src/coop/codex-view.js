...
const KINDS={advance:'配对进阶',mastery:'组合精通',role:'职业',active:'主动技能',core:'职业核心',form:'技能形态',evolution:'职业进化',passive:'被动组件',awakening:'通用觉醒',attribute:'升级属性',weapon:'武器',armor:'防具',affix:'装备词条','equipment-rarity':'装备品质',bonus:'限时奖励怪',objective:'冒险目标',enemy:'普通怪物',boss:'首领','enemy-rarity':'怪物稀有度',trait:'怪物词条'};
